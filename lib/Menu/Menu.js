...
var Menu = _react2.default.createClass({
  ...
  _cloneMenuItem: function _cloneMenuItem(child, childIndex, styles, index) {
    var _this = this;
    ...
    return _react2.default.cloneElement(child, {
      ...
      onTouchTap: function onTouchTap(event) {
        _this._handleMenuItemTouchTap(event, child, index);
  ...
  _handleMenuItemTouchTap: function _handleMenuItemTouchTap(event, item, index) {
  ...
  render: function render() {
    ...
    var newChildren = _react2.default.Children.map(filteredChildren, function (child, index) {
      ...
      var clonedChild = childIsADivider ? _react2.default.cloneElement(child, { style: styles.divider }) : childIsDisabled ? _react2.default.cloneElement(child, { desktop: desktop }) : _this3._cloneMenuItem(child, menuItemIndex, styles, index);
